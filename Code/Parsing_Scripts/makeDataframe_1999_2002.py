...
for line in lines:
   ...
   occurenceState = str(line[118:120])  #[20:22]  #eg. UT
   occurenceState = state_FIPS[occurenceState]
   occurenceCountyFIPS = str(line[120:123]) #str(line[22:25]) #NO int conversion
#   occurenceNYCcode = str(line[25:27]) #YC = NYC code, we don't care about that
   ...
   residenceState = str(line[123:125]) #line[28:30] #NOTE ZZ=foreign resident, also could have
   residenceState = state_FIPS[residenceState]
   #territories here?
#   residenceStateCountry = line[32:34] #recode of above with some countries
   residenceCounty = str(line[125:128]) #county FIPS
   residenceCity = str(line[96:101]) #City FIPS, didn't know these existed
...
#   birthStateCountry = line[58:60] #recode of above with some countries
   ...
   edu1989 = int(line[51:53]) #see data dictionary
   eduHS = 0
   if edu1989 == 99:
      eduHS = np.nan
   elif edu1989 >= 12:
   ...
   ageType = str(line[63]) #1= age in years, 2=months,3=days,4=hours,5=minutes,9=NA
   ...
   ageYears = 0
   if ageType == '0' or ageType == '1': #Next three digits are years
      ageYears = ageNum

   ageSub = line[137] #1=age was calculated from birth/death, blank=reported
   ...
   if maritalStatus == '1':
      ...
      maritalStatus = 'U'
   dayOfWeek = line[82] #Coded day of week e.g.3=  Tuesday Suicide Tuesday?
   dataYear = line[114:118] # current data year e.g. 2003? May want to check
...
#   pregnancy = line[142] #Could be interesting, see table
   ...
   ICD10 = str(line[141:145])
   ICDrecode358 = str(line[145:148])
   ICDrecode113 = str(line[150:153])
   ICDrecode130 = str(line[153:156])
   ICDrecode39 = str(line[156:158])
   #Multiple conditions
...
#END OF NEW MULTIPLE CONDS
   ...
   raceImputed = line[136] #1=Imputed, blank=not
   ...
   numLines += 1
colNames = ['Record_type','Resident_Status','Occurence_State','Occurence_County','Occurence_County_PopSize','Resident_State','Resident_County_FIPS','Resident_City_FIPS', 'Resident_City_NOT_FIPS','Resident_City_PopSize','Resident_Metro','Birth_State','EDU_1989','EDU_HS','Death_Month','Gender','Age_Type','Age_Number','Age_Years','Age_Calc','Age_Recode_52','Age_Recode_27','Age_Recode_12','Age_Recode_22','Death_Place','Martial_Status','Day_of_week','Data_Year','Work_Injury','Manner_of_Death','Activity_Code','Place_of_Injury','ICD10','ICD358','ICD113','ICD130','ICD39','Race','Race_Imputed','Race_Recode_3','Race_Hispanic_Code','Race_Hispanic_Recode', 'Num_EA_Conditions', 'EA_Condition_01', 'EA_Condition_02', 'EA_Condition_03','EA_Condition_04','EA_Condition_05','EA_Condition_06','EA_Condition_07','EA_Condition_08', 'EA_Condition_09','EA_Condition_10', 'EA_Condition_11', 'EA_Condition_12','EA_Condition_13','EA_Condition_14','EA_Condition_15','EA_Condition_16','EA_Condition_17','EA_Condition_18','EA_Condition_19','EA_Condition_20', 'Num_RA_Conditions', 'RA_Condition_01', 'RA_Condition_02', 'RA_Condition_03','RA_Condition_04','RA_Condition_05','RA_Condition_06','RA_Condition_07','RA_Condition_08', 'RA_Condition_09','RA_Condition_10', 'RA_Condition_11', 'RA_Condition_12','RA_Condition_13','RA_Condition_14','RA_Condition_15','RA_Condition_16','RA_Condition_17','RA_Condition_18','RA_Condition_19','RA_Condition_20', 'Occupation']
