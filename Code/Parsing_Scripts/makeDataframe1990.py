...
#   activityCode = line[139] #active at time of death, see table
   ...
   #NOTE entity-RA conditions were not listed in the 1990 guide
   #but appear in the file so I will include them.
